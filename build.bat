...
cl /Wall /WX /Zi -D_CRT_SECURE_NO_WARNINGS %warnings% /MTd /Od compiler.c user32.lib && nasm out.asm -f win64 && compiler && link.exe out.obj Kernel32.lib /subsystem:console /entry:_start
